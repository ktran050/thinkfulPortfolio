...
function renderProjects() {
  ...
  <div class="container">
    <div class="pictureSide">
      ...
      <img
      src="https://github.com/ktran050/coronaTracker/raw/master/img/ct-desktop-view.PNG"
      alt=""
      class="projectImg"
    /><br>
    <p>
      <div class="link-list"><a href="https://ktran050.github.io/coronaTracker" target="_blank">Live Demo</a><a href="https://github.com/ktran050/coronaTracker" target="_blank">Github Repo</a></div>
    </p>
  </div>
  <div class="linkSide">
      <p>
        An application to compare the number of cases in a single or group of countries for the COVID-19 virus.
      </p>
      <h3> Made With: </h3>
      <div class="badge-list">
        <div><img src="https://www.pinclipart.com/picdir/big/74-746817_contact-us-for-a-free-consultation-and-quote.png" alt="HTML5 Logo" class="big-badge"></div>
